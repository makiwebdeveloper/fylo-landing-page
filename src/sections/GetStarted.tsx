...
const GetStarted: FC = () => {
  return (
    <div className="bg-gray-200 relative h-0">
      <div
        id="signin"
        className="bg-background-100 w-[300px] md:w-[700px] absolute left-[50%] translate-x-[-50%] translate-y-[-40%] md:translate-y-[-60%] py-10 px-14 shadow-xl rounded-lg text-center"
      >
